...
4. Execute o servidor localmente (desenvolvimento):
...
5. Deploy na Vercel:
A configuração do Vercel já está no arquivo `vercel.json`. Basta subir esse repositório para o GitHub e importá-lo na Vercel. Lembre-se de configurar as variáveis de ambiente lá também (nas configurações do projeto na Vercel -> Environment Variables).
